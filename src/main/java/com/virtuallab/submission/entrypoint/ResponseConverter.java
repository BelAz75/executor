...
public class ResponseConverter {
    ...
    public static SubmissionResponse toResponse(SubmissionEntity submissionEntity) {
        return new SubmissionResponse(submissionEntity.getId(), submissionEntity.getSubmittedAt(), submissionEntity.getLanguage(), submissionEntity.getStatus(), submissionEntity.getError(), submissionEntity.getTestsPassed());
    }
